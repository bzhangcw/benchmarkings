...
from print_result import format_object
...
print(df.applymap(format_object).to_latex(longtable=True, multirow=True, multicolumn=True))
print(dfa.applymap(format_object).to_latex(longtable=True, multirow=True, multicolumn=True))
df.to_excel("1.xlsx")
dfa.to_excel("2.xlsx")